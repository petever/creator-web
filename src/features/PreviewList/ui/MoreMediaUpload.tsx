...
export const MoreMediaUpload = ({
  ...
  return (
    <div className="absolute bottom-2.5 right-2.5 z-10">
      <Button type='button' onClick={handlePreviewStatusChange}>
        <IconAdjustments style={{ width: '70%', height: '70%' }} stroke={1.5} />
      </Button>
      {isPreview && (
        <div className="flex items-center gap-2.5 absolute -top-32 right-0 min-w-64 p-2.5 rounded-lg bg-gray-300">
          <Button type='button' variant='ghost' onClick={onOpenDropzone}>업로드</Button>
